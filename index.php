...
<html lang="en">
  <head>
    <title>Cosmeds | Complete Cosmetics Range</title>
    <meta charset="utf-8">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-6 copyright">
            <p>© 2025 Cosmeds. All rights reserved.</p>
          </div>
          <div class="col-md-6 credit-link text-start text-md-end">
            <p>Developed by <a href="https://techsphereinnovations.co.in/">Tech Sphere Innovations</a></p>
          </div>
        </div>
      </div>
    </div>
